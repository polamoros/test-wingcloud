...
// backend/target/test/main.wsim/.wing/inflight.$Closure3-9.cjs
var require_inflight_Closure3_9 = __commonJS({
  "backend/target/test/main.wsim/.wing/inflight.$Closure3-9.cjs"(exports2, module2) {
    "use strict";
...
var require_resource = __commonJS({
  "../../../.nvm/versions/node/v20.11.1/lib/node_modules/winglang/node_modules/@winglang/sdk/lib/std/resource.js"(exports2) {
    ...
    var Resource = class extends constructs_1.Construct {
       ...
       */
      _preSynthesize() {
        if (this._liftMap === void 0) {
          return;
        }
        const data = this._liftMap;
        for (const [op, liftEntries] of Object.entries(data)) {
          for (const [dep, depOps] of liftEntries) {
            if (!constructs_1.Construct.isConstruct(dep)) {
              continue;
            }
...
// backend/target/test/main.wsim/.wing/handler_c845ef9c.sandbox.cjs
var $handler = void 0;
