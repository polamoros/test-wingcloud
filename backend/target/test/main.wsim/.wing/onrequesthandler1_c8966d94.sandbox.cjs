...
exports.handler = async function(event) {
  ...
  handler: 
          ...
          require("/Users/polamoros/Projects/WingCloud/test-wingcloud/backend/target/test/main.wsim/.wing/inflight.$Closure2-9.cjs")({
            $counter: (function() {
  ...
  return require("@winglang/sdk/lib/simulator/client").makeSimulatorClient(simulatorUrl, handle, caller);
      ...
      require("/Users/polamoros/Projects/WingCloud/test-wingcloud/backend/target/test/main.wsim/.wing/inflight.Broadcaster-8.cjs")({
      })
    ;
  ...
  return require("@winglang/sdk/lib/simulator/client").makeSimulatorClient(simulatorUrl, handle, caller);
      ...
      require("/Users/polamoros/Projects/WingCloud/test-wingcloud/backend/target/test/main.wsim/.wing/inflight.WebSocket-7.cjs")({
      })
    ;
