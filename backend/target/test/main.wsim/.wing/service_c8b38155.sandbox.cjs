      ...
      exports.start = async function() {
        ...
        const client = await 
          ...
          require("/Users/polamoros/Projects/WingCloud/test-wingcloud/backend/target/test/main.wsim/.wing/inflight.$Closure1-1.cjs")({
            $Vite_sim: 
      require("/Users/polamoros/Projects/WingCloud/test-wingcloud/backend/target/test/main.wsim/.wing/inflight.Vite_sim-1.cjs")({
      })
    ,
